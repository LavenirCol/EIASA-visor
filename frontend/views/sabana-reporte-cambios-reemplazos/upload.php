        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card-deck">
                    <div class="card">
                        <div class="card-body">
                            <form id="formupload" action="<?php echo Url::toRoute('sabana-reporte-cambios-reemplazos/upload'); ?>" method="POST" enctype="multipart/form-data">
                            <h5 class="card-title">1. Seleccione el archivo Excel para Actualizar la Sabana de Cambios y Reemplazos</h5>
            ...
            <div class="col-lg-4">
                <div class="card-deck">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Ejemplo de archivo Excel para Actualizar la sabana de Cambios y Reemplazos</h5>
                            <p class="card-text">Puede descargar el formato a utilizar en los cargues de información desde los siguienets links.</p>
                            <ul>
                                <li>
                                    <a href="<?= Url::base(true);  ?>/files/Formato Modulo Cambios y Reemplazos.xlsx" class="">Archivo Excel Sabana Cambios y Reemplazos</a>
                                </li>                                
                            </ul>
                        </div>
                    </div>            
