            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Actualizar Sabana Instalaciones</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0">Actualizar Sabana Instalaciones</h4>
            </div>
        </div>
    </div><!-- container -->
</div><!-- content -->
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card-deck">
                    <div class="card">
                        <div class="card-body">
                            <form id="formupload" action="<?php echo Url::toRoute('accesosinstalacion/upload'); ?>" method="POST" enctype="multipart/form-data">
                            <h5 class="card-title">1. Seleccione el archivo Excel para Actualizar la Sabana de Instalaciones</h5>
            ...
            <div class="col-lg-4">
                <div class="card-deck">
                    <div class="card">
                        <div class="card-body">
                            <form id="formupload" action="<?php echo Url::toRoute('accesosinstalacion/upload'); ?>" method="POST" enctype="multipart/form-data">
                            <h5 class="card-title">2. Seleccione el archivo Excel para Actualizar las Metas de Instalaciones</h5>
            ...
            <div class="col-lg-4">
                <div class="card-deck">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Ejemplo de archivo Excel para Actualizar la sabana de Instalaciones</h5>
                            <p class="card-text">Puede descargar el formato a utilizar en los cargues de información desde los siguienets links.</p>
                            <ul>
                                <li>
                                    <a href="<?= Url::base(true);  ?>/files/Formato Modulo Instalacion.xlsx" class="">Archivo Excel Sabana</a>
                                </li>
                                <li>
                                    <a href="<?= Url::base(true);  ?>/files/Dashboard Metas Instalacion.xlsx" class="">Archivo Excel Metas</a>
                                </li>
                            </ul>
                        </div>
                    </div>            
