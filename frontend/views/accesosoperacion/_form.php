...
<div class="sabana-accesos-operacion-form">
    ...
    <?= $form->field($model, 'Fecha_de_cumplimiento_de_meta')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'Fecha_inicio_operacion')->textInput(['maxlength' => true]) ?>
