...
/* @var $model app\models\SabanaAccesosOperacionSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sabana-accesos-operacion-search">
    ...
    <?= $form->field($model, 'sabana_accesos_operacion_id') ?>
    ...
    <?php // echo $form->field($model, 'Fecha_de_cumplimiento_de_meta') ?>
    ...
    <?php // echo $form->field($model, 'Fecha_inicio_operacion') ?>
